...
固定模型参数并更换三组场景随机种子后，\(S_{\mathrm{all}}\) 相对 \(S_0\) 的全年节省均为正，范围为 \(31.67\sim34.37\) 万元；采用备选结算口径后，全年仍可节省 \(12.23\) 万元。因此，日内滚动更新能够降低费用的结论具有稳健性，但18点更新相对 \(S_{6,12}\) 的微小增益不具备稳定证据。
